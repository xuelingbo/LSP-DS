...
!---------------------------------------------------------------------
    ...
    integer                 :: distributed_ahe_opt = 0   ! xue.lingbo: add for distributed anthropogenic heat option 2026/04/08
    ...
    character(len=256)      :: forcing_name_AHE = "AHE"   ! xue.lingbo 2026/04/08
    ...
    namelist / NOAHLSM_OFFLINE /    &
         ...
         forcing_name_AHE,                                                                &     ! xue.lingbo 2026/04/08
         ...
         sf_urban_physics,distributed_ahe_opt,use_wudapt_lcz,num_urban_hi,urban_atmosphere_thickness,         &     ! xue.lingbo 2026/04/08
   ...
   !
    ...
    NoahmpIO%distributed_ahe_opt               = distributed_ahe_opt         ! xue.lingbo 2026/04/08
    ...
    NoahmpIO%forcing_name_AHE                  = forcing_name_AHE            ! xue.lingbo 2026/04/08
